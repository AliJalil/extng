...
(2, 'كشف ش 4', '2023-04-01', '2023-04-07', 2, 'فلاغبفيلغ', 1, 0, '1680167192', 60);
...
(1, 50, 660, 'مطفئة', '2', '3', 'Ullam e23', 'لاتوجد ملاحظات', 1, 60, 1, 0, 60, '1677607266'),
...
(6, 50, 665, '5مطفئ', '2', '3', 'ما اندلهاموجوده', 'لاتوجد ملاحظات', 0, -1, 1, 0, 60, '1677607266'),
...
(16, 7, 45, 'مطفئة صحن فاطمة', '2', '1', 'صحن فاطمة', 'فثس', 0, -1, 1, 0, 60, '1680167123');
...
(60, 'ميسر منذر عدنان', 'hh', '$2y$10$I95ImwlL5xW.jFj2XA.J3OnXfAHzaC6U9XwBVxqGlHpKstXyDmaxO', 'http://imamali.tech:50031/gifts/images/statics/noimageicon.png', 0, 1, 0, 0, '1672847973'),
...
(65, 'Iola Irwin', 'MM', '$2y$10$zFx8Yp4dUryKpq3StA.v6esP2vQS.ct4s1eXNaarUUP3ubQZX43R6', 'http://localhost/extng/images/statics/noimageicon.png', 0, 1, 0, 0, '1683275862'),
(66, 'Adara Garrison', 'nabawin', '$2y$10$n4vnnmtrMaFCfZWXEifqOu7pZwQKLVozxIUI.WjV8pJxUktmGQVgO', NULL, 1, 1, 0, 0, '1683276948'),
(67, 'Bruce Farmer', 'fywamyfe', '$2y$10$v7c1OpdwUKpAuQL2MCxIluRDerR7WUtLA5ViAmTdez2gBpIZLr91W', NULL, 1, 1, 0, 0, '1683276980'),
(68, 'Malachi Mcdonald', 'zonofehuzi', '$2y$10$lYC.9ndypBqj47U3D2Iace5UsEve6OImtfuOEX8GH9k1p4XsndS7K', NULL, 1, 1, 0, 0, '1683277022'),
(69, 'Thaddeus Wilder', 'kuxozybyru', '$2y$10$TxrtEP/F.5493PClpEXtdu9UmRROinFhzTH2R4CinUFiL598qKdFC', NULL, 1, 1, 0, 0, '1683277145'),
(70, 'Amelia Scott', 'sykuvytuho', '$2y$10$V/B/BLA0U7H8uZuMuPyZ5e.mu6dtVauc/r9xXkh98DQkmK9La/L0G', NULL, 1, 1, 0, 0, '1683277223'),
(71, 'Nichole Mays', 'faqup', '$2y$10$izTQ9LjnZbkMvkY3Oo.WGu8QbQJxZDaSUGh9UXTUPN8OaN../4q0O', NULL, 1, 1, 0, 0, '1683277303'),
(72, 'Breanna Mueller', 'zacul', '$2y$10$BD6nLFFenlX2euKNuxE8Lu00dVIjVkEYGdi2hA2ajAG3UqgzlfwSO', NULL, 1, 1, 0, 0, '1683277422'),
(73, 'Clare Beach', 'qabinup', '$2y$10$FtniVdogzA/lzUVi7AXDwu6zDQ46NwMWP2l/JArwE3J2CwfVGeEbm', NULL, 1, 1, 0, 0, '1683277811');
...
--
ALTER TABLE `detectionemps`
  MODIFY `deId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `userpermissions`
  MODIFY `upId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1070;
