        ...
        <div class="table-responsive">
            ...
            <table id="detailsTable"
                ...
                <tr class="mjk" pcolor=#CCCCCC>
                    ...
                    <?php if (checkPermission($data['permissions'], 'GoldExpert') || checkPermission($data['permissions'], 'Checker')): ?>
            ...
            <div>
                ...
                <div id="extraAmountSum"></div>
                <div id="amountSum"></div>
            </div>
        </div>
    </div>
</div>
...
<script>$( document ).ready( function () {
        ...
        var emTable = $( '#detailsTable' ).DataTable( {
                ...
                <?php endif;?>
                {
                    ...
                    render: function (data, type, row) {
                        return '<div style="margin-top: 5px">' +
                            '                             <a target="_blank" href="<?php echo URLROOT . "/main/gold/"; ?>' + row['gGId'] + '"style="transition: all 0.3s; background: #EDEDED;color: red;" data-toggle="tooltip" title="معاينة الوصل"' +
                            '                                    class="btn  btn-sm">' +
            ...
            drawCallback: function () {
                var api = this.api();
                $( '#extraAmountSum' ).text( "  مجموع الوزن المدخل: " + api.column( 3, {page: 'current'} ).data().sum() );// ;
                $( '#amountSum' ).text( "  مجموع وزن الخبير: " + api.column( 4, {page: 'current'} ).data().sum() );// ;
