...
<div class="MA-vistitem2 ma-border4">
    ...
    <div class="nmbjiu2 not-print">
        <a href="<?php echo URLROOT . "/statistics/index/"; ?>">
            <button class="ma-backf"><i style="font-weight: bold; padding-top: 10px;" class="far fa-arrow-right"></i>
            </button>
...
<script>
    $( document ).ready( function () {
            ...
            function getData(formData) {
                ...
                $.ajax( {
                        url: '<?php echo URLROOT . "/statistics/summary/0/1";?>' + path,
                        method: "post",
                        data: formData,
                        contentType: false,
                        processData: false,
            ...
            function bindData(data) {
                ...
                if (path == "1") {
                    $( "#statisticsName" ).text( "كشف العملات العام" );
                } else if (path == "999") {
                    $( "#statisticsName" ).text( "كشف العملات العربية والاجنبية" );
                }
                ...
                ids.forEach( item => {
                    ...
                    rowC += 1;
                    text =
                        '<div class="accordion-item" style="direction: rtl;">' +
                        ...
                        ' style="display: inline-flex;text-align: justify;width: 15%; justify-content: space-between">' +
                    ...
                    // document.getElementById( "accordionFormat" ).innerHTML = text;
                    $( '#accordionFormat' ).append( text );

                    objs.forEach( obj => {
                        var tableBody = '  <tr>' +
                            ' <td>' + obj.dName + '</td>' +
                            '<td>' + addCommas( obj.amount ) + '</td>' +
                            ' <td>' + obj.sName + '</td>' +
                            '</tr>';
