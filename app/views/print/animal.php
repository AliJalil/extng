...
<div class="MA-vistitem edit1 print1">
    ...
    <div class="ma-left print">
        ...
        <table class="erprint anmilforprint">
            ...
            <tr>
                <td>
                    <label>نذر لله تعالى حباُ لآمير المؤمنين علي بن ابي طالب(ع)</label>
                </td>
            </tr>
...
<script>
    $( document ).ready( function () {
        $( '#amountWriting' ).text( tafqeet(<?php echo $gift->amount; ?>, 'PURE' ) );
        console.log( tafqeet(<?php echo $gift->amount; ?>, 'PURE' ) )
