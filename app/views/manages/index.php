                    ...
                    <div class="pop-up-content-wrap">
                        <form class="nameFoo2 so" method="post" id="addType">
                            ...
                            <table>
                                ...
                                <td>
                                    <input id="sName" name="tName" class="ma-forplace tName"
...
<script>$( document ).ready( function () {
            ...
            columnDefs: [
                {
                    targets: "tName_th",
                    render: function (data, type, row) {
                        return '<a class="tName" id="tName" data-name="tName"  data-type="text" data-pk=' + row['tId'] + '>' + data + '</a>'
                    }
                },
                {
                    targets: "state_th",
        ...
        typesTable.on( 'draw', function () {
            <?php if (checkPermission($data['permissions'], 'ManagePage'))  : ?>
            make_editable_x( '.gName', "<?php echo URLROOT . "/manages/edit/2";?>" );
            make_editable_x( '.price', "<?php echo URLROOT . "/manages/edit/2";?>" );
