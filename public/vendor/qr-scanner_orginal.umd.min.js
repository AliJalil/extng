...
(function (e, a) {
    ...
    class e {
        ...
        async start() {
            ...
            if (!this._active || this._paused) if ("https:" !== window.location.protocol && console.warn( "The camera stream is only accessible if the page is transferred via https." ), this._active = !0, !document.hidden) if (this._paused =
                !1, this.$video.srcObject) await this.$video.play(); else try {
        ...
        static async scanImage(a, b, c, d, f = !1, h = !1) {
            ...
            try {
                ...
                } else q = await Promise.race( [new Promise( (g, l) => window.setTimeout( () => l( " خطأ في القراءة: timeout" ), 1E4 ) ), (async () => {
                    try {
        ...
        static async createQrEngine(a) {
            ...
            return b && b.brands.some( ({brand: c}) => /Chromium/i.test( c ) ) && /mac ?OS/i.test( b.platform ) && await b.getHighEntropyValues( ["architecture", "platformVersion"] ).then( ({
                                                                                                                                                                                                  architecture: c,
                                                                                                                                                                                                  platformVersion: d
                                                                                                                                                                                              }) => /arm/i.test( c || "arm" ) && 13 <= parseInt( d || "13" ) ).catch( () => !0 ) ? a() : new BarcodeDetector( {formats: ["qr_code"]} )
        }
        ...
        _updateOverlay() {
            requestAnimationFrame( () => {
                if (this.$overlay) {
                    var a = this.$video, b = a.videoWidth, c = a.videoHeight, d = a.offsetWidth, f = a.offsetHeight,
                        h = a.offsetLeft,
                        m = a.offsetTop, n = window.getComputedStyle( a ), p = n.objectFit, k = b / c, q = d / f;
                    switch (p) {
                        case "none":
                            var g = b;
                            var l = c;
        ...
        async _getCameraStream() {
            ...
            let a = /^(environment|user)$/.test( this._preferredCamera ) ? "facingMode" :
                    "deviceId", b = [{width: {min: 1024}}, {width: {min: 768}}, {}],
        ...
        static _drawToCanvas(a, b, c, d = !1) {
            ...
            let f = b && b.x ? b.x : 0, h = b && b.y ? b.y : 0, m = b && b.width ? b.width : a.videoWidth || a.width,
        ...
        static async _loadImage(a) {
            ...
            if (a instanceof
                File || a instanceof Blob || a instanceof URL || "string" === typeof a) {
                let b = new Image;
